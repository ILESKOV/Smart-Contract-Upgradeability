...
module.exports = async function (deployer, network, accounts) {
  ...
  console.log("number of dogs in Dogs Storage: " + nrOfDogs.toNumber());
  
  //Deploy new version of Dogs with fixed owner initialization
  ...
  //Set the nr of dogs through the proxy with NEW FUNCTIONAL CONTRACT
